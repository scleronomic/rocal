...
def leave_one_out_analysis():
    ...
    cal_rob = Justin19Calib(dcmf='ff0c', ma0=True, fr0=True, use_imu=True, cp_loop=1)
    ...
    for name in name_list:
        print(name)
        _cal_rob = Justin19Calib(dcmf='cc0c', ma0=True, fr0=True, use_imu=True, cp_loop=0)
        if name == 'd':
